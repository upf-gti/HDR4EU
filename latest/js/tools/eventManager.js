...
class EventManager {
    ...
    constructor(webGLcontext, controller) {
        ...
        this.wheel_speed = 1;
        this.keys = {};
        this.mouseCollision = vec3.create();
    ...
    bindMouse(ctx) {
        ...
        ctx.onmousemove = function(e)
        {
            ...
            if (e.leftButton && that.is_mouse_down) {
                ...
                // controller.panning( e, that.mouseCollision );
            }
        }
        ...
        ctx.onmousedown = function(e)
        {
            ...
            const front = controller.camera.getFront();
            Tools.testPerpendicularPlane( e.canvasx, gl.canvas.height - e.canvasy, front, that.mouseCollision, controller.camera );
