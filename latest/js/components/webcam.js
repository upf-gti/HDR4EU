...
TextureWebcam.icon = "https://webglstudio.org/latest/imgs/mini-icon-photo.png";
...
Object.assign( TextureWebcam.prototype, {
	...
	create(widgets, no_section) {
		...
		{
			var element = widgets.addSection("Webcam", {collapsed: that.collapsed, callback: function(no_collapsed){
				that.collapsed = !no_collapsed;
			}});
		
			element.addEventListener("dragstart", function(e){
					e.dataTransfer.setData("type", "gui");
					e.dataTransfer.setData("component", "Webcam");
			});
		...
		var add_component_node = widgets.addButton(null, "&#10008; Delete component", {callback: function(){
			...
			that.closeStream();
			delete that.node.components["Webcam"];
