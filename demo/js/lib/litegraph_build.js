...
*/
	...
	*/
    ...
    LGraphCanvas.prototype.renderInfo = function(ctx, x, y) {
        ...
        ctx.fillStyle = "#888";
        if (this.graph) {
            ctx.fillText("N: " + this.graph._nodes.length + " [" + this.visible_nodes.length + "]", 5, 13 * 1 );
            ctx.fillText("FPS:" + this.fps.toFixed(2), 5, 13 * 2);
            // ctx.fillText("I: " + this.graph.iteration, 5, 13 * 3 );
            //ctx.fillText( "T: " + this.graph.globaltime.toFixed(2) + "s", 5, 13 * 4 );
            // ctx.fillText("V: " + this.graph._version, 5, 13 * 5);
        } else {
