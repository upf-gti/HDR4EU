...
Object.defineProperty(SFX.prototype, 'gamma_correction', {
	get: function() { return this._gamma_correction; },
	set: function(v) { this._gamma_correction = v; CORE.setUniform("GammaCorrection", v); },
	enumerable: true
});

Object.defineProperty(SFX.prototype, 'linear_space', {
	get: function() { return this._linear_space; },
	set: function(v) { this._linear_space = v; CORE.setUniform("ConvertToLinear", v); },
	enumerable: true
});
...
Object.assign( SFX.prototype, {
	...
	create(widgets, root) {
		...
		widgets.on_refresh = function(){
			...
			widgets.addSlider("Aperture", that.aperture || 2.5, {min: MIN_APERTURE, max: MAX_APERTURE, step: 0.1, callback: function(v) { that.aperture = v; }});
			widgets.addSlider("Shutter speed", that.shutterSpeed || 1/15, {min: MIN_SHUTTER_SPEED, max: MAX_SHUTTER_SPEED, step: 0.5, precision: 4,callback: function(v) { that.shutterSpeed = v; }});
			widgets.addSlider("ISO", that.iso || 300, {min: MIN_SENSITIVITY, max: MAX_SENSITIVITY,step:100, integer: true,callback: function(v) { that.iso = v; }});
			...
			widgets.addCheckbox("Linear Space",  that.linear_space, {callback: function(v){ that.linear_space = v; }});
			widgets.addCheckbox("Gamma",  that.gamma_correction, {callback: function(v){ that.gamma_correction = v; }});
			widgets.widgets_per_row = 1;
