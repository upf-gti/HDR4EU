...
THREE.EXRLoader.prototype._parser = function ( buffer ) {
	...
	if (EXRHeader.compression === 'ZIP_COMPRESSION') {
		...
		// var vsub = v.subarray( offset.value );
		// var data_bytearray = new Uint8Array( vsub );
		// var inflated = pako.inflate( data_bytearray.buffer);
	}

	else if (EXRHeader.compression == 'NO_COMPRESSION') {
